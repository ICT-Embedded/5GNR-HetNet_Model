function [SE_DL_SC] = functionComputeSE_DL_SC(H,Hhat,nbrOfSubcarriers,...
    M,K,L,Hbuilder_SC,Pmax_SC,center_frequency_SC)
%
%This function is used to compute DL spectral efficiency for small cells
%
%INPUT:
%
...
%OUTPUT:
%
%SE_DL_SC = K x L matrix of spectral efficiencies [b/s/Hz] calculated using
%OMP approach
%

%Prepare to store simulation results for spectral efficiencies
SE_DL_SC = zeros(K,L);
...
SE_DL_SC = SE_DL_SC / nbrOfSubcarriers; %average over subcarriers
